#!name = WARP节点查询
#!desc = 显示WARP节点的详细信息，请在所有节点页面选择一个节点长按，出现菜单后进行测试。
...
#!date = 2024-03-04 12:01:01

[Script]
# WARP节点查询
generic script-path = 1.1.1.1.panel.js, timeout = 10, tag = WARP · INFO, img-url = icloud.circle.system
