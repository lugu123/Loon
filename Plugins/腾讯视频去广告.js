...
[Script]
http-request ^https?:\/\/vv\.video\.qq\.com\/getvinfo script-path = Tencent_Video_replace-body.js, requires-body = true, argument = "&sppreviewtype=\d(.*)&spsrt=\d->&sppreviewtype=0$1&spsrt=0", tag = 移除广告
